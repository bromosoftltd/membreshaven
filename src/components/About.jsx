...
const About = () => {
  return (
    <div
      id="about"
      className="lg:w-[95%] w-full relative xl:min-h-[85vh] mb-4 min-h-[60vh] m-auto lg:mt-6 lg:p-6 lg:bg-[top_center] bg-contain lg:rounded-[40px]  bg-[#F6F3ED] dark:bg-gray-700 bg-no-repeat  bg-[url(/images/about-bg.png)]"
    >
      <h3 className="text-center absolute top-10 font-semibold text-gray-600 left-1/2 py-1 px-2 rounded-full uppercase text-[11px] bg-white w-max">
        about us
      </h3>
      <div className="flex lg:flex-row flex-col-reverse xl:min-h-[80vh] min-h-[60vh]">
        ...
        <div className="lg:mt-12 mt-16 lg:w-1/2 flex gap-4 flex-col items-center sm:p-6 p-2">
          <h1 className="xl:text-5xl text-4xl font-bold dark:text-white text-gray-700">
          Discover Your Inner
          Peace Wellness.
          </h1>
          ...
          <div className="flex mt-3 sm:gap-0 gap-4 sm:justify-between sm:flex-row flex-col  w-full sm:items-center">
            <ul className="flex flex-col sm:gap-8 gap-4">
              <li className="font-bold flex items-center gap-2 text-gray-700 dark:text-white text-lg">
